...
const SidebarTimer: React.FC<SidebarTimerProps> = ({
    ...
    return (
        <div className="w-[200px] h-[1080px] bg-white relative">
            {/* 시작 / 종료 박스 */}
            <div className="h-[126px] absolute top-[70px] left-[25px] rounded-[10px] border border-[#E8E8E8] bg-white flex flex-col gap-[19px] p-[20px]">
                {/* 시작 */}
                <div className="flex items-center gap-[15px]">
                    <div className=" h-[24px] flex items-center justify-center font-pre font-semibold text-[18px] leading-[1] tracking-[-0.02em] text-[#27CFA5] bg-transparent rounded">
                        시작
                    </div>
                    <div className="h-[24px] flex items-center justify-center font-pre font-medium text-[18px] leading-[1] tracking-[-0.02em] text-[#555555] bg-transparent rounded">
            ...
            {/* 남은 시간 박스 */}
            <div className="h-[126px] absolute top-[210px] left-[25px] rounded-[10px] border border-[#E8E8E8] bg-white flex flex-col gap-[19px] p-[20px]">
                {/* 남은 시간 */}
