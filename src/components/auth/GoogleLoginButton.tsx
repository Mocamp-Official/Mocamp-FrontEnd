...
const GoogleLoginButton = () => {
  ...
  return (
    <button
      ...
      className="flex bg-white w-full h-16 justify-center items-center relative border border-gray-300 group"
    >
      ...
      <p className="text-gray-700 text-lg font-semibold">구글 계정으로 시작하기</p>
