...
const NaverLoginButton = () => {
  ...
  return (
    <button
      ...
      className="flex bg-[#05C050] w-full h-16 justify-center items-center relative border border-gray-300 rounded-[5px] group"
    >
      ...
      <p className="text-[#ffffff] text-lg font-semibold">네이버 계정으로 시작하기</p>
