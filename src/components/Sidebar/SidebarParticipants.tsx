...
const SidebarParticipants: React.FC<SidebarParticipantsProps> = ({ participants }) => {
    ...
    <div className="w-[200px] h-[1080px] bg-white flex items-center justify-center">
        <div className="w-[151px] h-[64px] top-[450px] rounded-[7.5px] border border-[#E8E8E8] bg-white flex flex-row items-center justify-between px-[15px] py-[10px] gap-[10px]">
