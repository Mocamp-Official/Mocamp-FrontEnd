...
const SlideCard1 = () => {
  return (
    // 전체 카드 컨테이너
    <div className="bg-gray2 border-gray4 flex h-[267px] w-[480px] shrink-0 gap-[28.67px] rounded-[20px] border px-[50px] lg:h-[375px] lg:w-[675px] lg:gap-10 xl:h-[500px] xl:w-[900px] xl:gap-[54px]">
      {/* 왼쪽 텍스트 블럭 (제목 + 설명) */}
      <div className="flex w-full flex-col gap-5">
        {/* 슬로건 제목 */}
        <span className="text-primary xl:text-title2 mt-[36.27px] flex h-[45px] items-center text-[15px] lg:mt-[51px] lg:text-[21px] xl:mt-[68px]">
          누구나 쉬운 목표 관리
        </span>

        {/* 설명 문구 */}
        <span className="text-gray9 xl:text-title3 flex h-10 items-center text-[12.8px] leading-[160%] font-medium lg:h-[58px] lg:text-lg xl:h-[76px]">
          오늘 수행할 목표를 작성하고, <br />
          체크박스를 눌러 게이지 UP!
        </span>
      </div>
      ...
      <div className="flex flex-col justify-center gap-[18px]">
        {/* 진행도 박스 */}
        <div className="bg-gray1 border-gray4 mt-[3px] flex flex-col gap-5 rounded-[10.67px] border p-4 lg:rounded-[15px] lg:p-[22.5px] xl:rounded-[20px] xl:p-[30px]">
        ...
        {/* 투두 리스트 박스 */}
        <div className="border-gray4 flex flex-col gap-5 rounded-[10.67px] border bg-white p-[50px] lg:rounded-[15px] xl:rounded-[20px]">
          {/* 투두 항목 1 (완료) */}
